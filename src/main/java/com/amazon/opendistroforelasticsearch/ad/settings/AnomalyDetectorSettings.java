...
public final class AnomalyDetectorSettings {
    ...
    public static final Setting<Integer>
        MAX_ANOMALY_DETECTORS =
        Setting.intSetting("ml.anomaly_detectors.max_anomaly_detectors", 1000, Setting.Property.NodeScope, Setting.Property.Dynamic);

    public static final Setting<Integer>
        MAX_ANOMALY_FEATURES =
        Setting.intSetting("ml.anomaly_detectors.max_anomaly_features", 5, Setting.Property.NodeScope, Setting.Property.Dynamic);

    public static final Setting<TimeValue>
        REQUEST_TIMEOUT =
        Setting.positiveTimeSetting("ml.anomaly_detectors.request_timeout",
    ...
    public static final Setting<TimeValue>
        DETECTION_INTERVAL =
        Setting.positiveTimeSetting("ml.anomaly_detectors.detection_interval",
    ...
    public static final Setting<Long>
        ...
        Setting.longSetting("ml.anomaly_detectors.ad_result_history_max_docs",
            10000L,
            0L,
            Setting.Property.NodeScope,
            Setting.Property.Dynamic);
    ...
    public static final Setting<TimeValue>
        BACKOFF_MINUTES =
        Setting.positiveTimeSetting("ml.anomaly_detectors.backoff_minutes",
            TimeValue.timeValueMinutes(15),
            Setting.Property.NodeScope,
            Setting.Property.Dynamic);

    public static final Setting<TimeValue> BACKOFF_INITIAL_DELAY = Setting.positiveTimeSetting("ml.anomaly_detectors.backoff_initial_delay",
        TimeValue.timeValueMillis(1000),
        Setting.Property.NodeScope,
        Setting.Property.Dynamic);

    public static final Setting<Integer>
        MAX_RETRY_FOR_BACKOFF =
        Setting.intSetting("ml.anomaly_detectors.max_retry_for_backoff", 3, 0, Setting.Property.NodeScope, Setting.Property.Dynamic);
