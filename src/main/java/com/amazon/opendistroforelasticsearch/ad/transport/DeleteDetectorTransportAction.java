...
public class DeleteDetectorTransportAction extends TransportMasterNodeAction<DeleteDetectorRequest, AcknowledgedResponse> {
    ...
    protected void masterOperation(
        DeleteDetectorRequest request, ClusterState state, ActionListener<AcknowledgedResponse> listener) throws Exception {
        throw new UnsupportedOperationException("Need a task ID");
    }

    @Override
    protected void masterOperation(
        Task task, DeleteDetectorRequest request, ClusterState state, ActionListener<AcknowledgedResponse> listener) throws Exception {
