...
// */
//public class MultiSearchResponsesDelegateActionListener<T> implements ActionListener<T> {
...
//
//    public MultiSearchResponsesDelegateActionListener(ActionListener<T> delegate, int maxResponseCount, String finalErrorMsg) {
...
//                }
//                this.delegate.onResponse(savedResponses);
//            }
//        } else {
