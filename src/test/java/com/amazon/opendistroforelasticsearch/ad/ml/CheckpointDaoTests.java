...
public class CheckpointDaoTests {
    ...
    public void putModelCheckpoint_getIndexRequest() {
        ...
        verify(clientUtil).timedRequest(indexRequestCaptor.capture(),
            anyObject(),
    ...
    public void getModelCheckpoint_returnExpected() {
        ...
        doReturn(Optional.of(getResponse)).when(clientUtil).timedRequest(getRequestCaptor.capture(),
            anyObject(),
    ...
    public void getModelCheckpoint_returnEmpty_whenDocNotFound() {
        doReturn(Optional.of(getResponse)).when(clientUtil)
    ...
    public void deleteModelCheckpoint_getDeleteRequest() {
        ...
        verify(clientUtil).timedRequest(deleteRequestCaptor.capture(),
            anyObject(),
