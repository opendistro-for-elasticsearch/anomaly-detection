...
public class ModelManagerTests {
    ...
    public void setup() {
        ...
        modelManager = spy(new ModelManager(
            clusterService,
            jvmService,
            rcfSerde,
            checkpointDao,
    ...
    public void getDetectorIdForModelId_returnExpectedId(
        String modelId, String expectedDetectorId) {
    ...
    private Object[] getDetectorIdForModelIdIllegalArgument() {
        return new Object[] {
            new Object[] { "testId" }, new Object[] { "testid_" }, new Object[] { "_testId" }, };
    }
    ...
    private Object[] combineRcfResultsData() {
        return new Object[] {
            ...
            new Object[] {
                asList(new RcfResult(1, 0, 40), new RcfResult(2, 0, 60), new RcfResult(3, 0, 100)), new CombinedRcfResult(2.3, 0) },
            ...
            new Object[] {
                asList(new RcfResult(0, 1, 20), new RcfResult(0, 1, 30), new RcfResult(0, 0.5, 50)), new CombinedRcfResult(0, 0.75) }, };
    }

    @Test
    @Parameters(method = "combineRcfResultsData")
    public void combineRcfResults_returnExpected(
        List<RcfResult> results, CombinedRcfResult expected) {
    ...
    public void getPartitionedForestSizes_returnExpected(
        long totalModelSize, long heapSize, ImmutableOpenMap<String, DiscoveryNode> dataNodes, Entry<Integer, Integer> expected) {
    ...
    public void getPartitionedForestSizes_throwLimitExceeded(
        long totalModelSize, long heapSize, ImmutableOpenMap<String, DiscoveryNode> dataNodes) {
        when(modelManager.estimateModelSize(rcf)).thenReturn(totalModelSize);
        when(jvmService.info().getMem().getHeapMax().getBytes()).thenReturn(heapSize);
        when(clusterService.state().nodes().getDataNodes()).thenReturn(dataNodes);
    ...
    private Object[] trainModelIllegalArgumentData() {
        return new Object[] {
            new Object[] { new double[][] {} }, new Object[] { new double[][] { {} } } };
    }

    @Test(expected = IllegalArgumentException.class)
    @Parameters(method = "trainModelIllegalArgumentData")
    public void trainModel_throwIllegalArgument_forInvalidInput(
        double[][] trainData) {
        modelManager.trainModel(anomalyDetector, trainData);
    }
