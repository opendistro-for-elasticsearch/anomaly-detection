...
public class AnomalyDetectorExecutionInputTests extends ESTestCase {
    ...
    public void testParseAnomalyDetectorExecutionInput() throws IOException {
        ...
        String
            detectInputString =
            TestHelpers.xContentBuilderToString(detectorExecutionInput.toXContent(TestHelpers.builder(), ToXContent.EMPTY_PARAMS));
        detectInputString =
            detectInputString
        ...
        AnomalyDetectorExecutionInput
            ...
            AnomalyDetectorExecutionInput.parse(TestHelpers.parser(detectInputString));
