...
public class AnomalyDetectorTests extends ESTestCase {
    ...
    public void testParseAnomalyDetectorWithNullFilterQuery() throws IOException {
        String
            detectorString =
            "{\"name\":\"todagtCMkwpcaedpyYUM\",\"description\":" +
                "\"ClrcaMpuLfeDSlVduRcKlqPZyqWDBf\",\"time_field\":\"dJRwh\"," +
                "\"indices\":[\"eIrgWMqAED\"]," +
                "\"feature_attributes\":[{\"feature_id\":\"lxYRN\",\"feature_name\":\"eqSeU\"," +
                "\"feature_enabled\"" +
                ":true,\"aggregation_query\":{\"aa\":{\"value_count\":{\"field\":\"ok\"}}}}]," +
                "\"detection_interval\":" +
                "{\"period\":{\"interval\":425,\"unit\":\"Minutes\"}}," +
                "\"window_delay\":{\"period\":{\"interval\":973," +
                "\"unit\":\"Minutes\"}},\"schema_version\":-1203962153," +
                "\"ui_metadata\":{\"JbAaV\":{\"feature_id\":" +
                "\"rIFjS\",\"feature_name\":\"QXCmS\",\"feature_enabled\":false," +
                "\"aggregation_query\":{\"aa\":" +
    ...
    public void testParseAnomalyDetectorWithEmptyFilterQuery() throws IOException {
        String
            ...
            "{\"name\":\"todagtCMkwpcaedpyYUM\",\"description\":" +
                ...
                "{\"period" +
                "\":{\"interval\":973,\"unit\":\"Minutes\"}},\"schema_version\":-1203962153,\"ui_metadata\":" +
                "{\"JbAaV\":{\"feature_id" +
                "\":\"rIFjS\",\"feature_name\":\"QXCmS\",\"feature_enabled\":false," +
                "\"aggregation_query\":{\"aa\":{\"value_count" +
                "\":{\"field\":\"ok\"}}}}}," +
    ...
    public void testNullDetectorName() throws Exception {
        TestHelpers.assertFailWith(IllegalArgumentException.class, () -> new AnomalyDetector(
