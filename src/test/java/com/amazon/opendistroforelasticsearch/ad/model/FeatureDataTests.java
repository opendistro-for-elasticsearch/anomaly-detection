...
public class FeatureDataTests extends ESTestCase {

    public void testParseAnomalyDetector() throws IOException {
        FeatureData featureData = TestHelpers.randomFeatureData();
        String
            featureDataString =
            TestHelpers.xContentBuilderToString(featureData.toXContent(TestHelpers.builder(), ToXContent.EMPTY_PARAMS));
        featureDataString =
            featureDataString
