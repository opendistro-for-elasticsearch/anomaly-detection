...
public class AnomalyDetectorRestApiIT extends AnomalyDetectorRestTestCase {
    ...
    private final String
        MONITOR_INDEX_MAPPING =
        "{\"mappings\":{\"_meta\":{\"schema_version\":1},\"properties\":" +
            "{\"monitor\":{\"dynamic\":\"false\"," +
            "\"properties\":{\"schema_version\":{\"type\":\"integer\"}," +
            "\"name\":{\"type\":\"text\"," +
            "\"fields\":{\"keyword\":{\"type\":\"keyword\",\"ignore_above\":256}}}," +
            "\"type\":{\"type\":\"keyword\"}," +
            "\"enabled\":{\"type\":\"boolean\"},\"enabled_time\":{\"type\":\"date\"," +
            "\"format\":\"strict_date_time||epoch_millis\"}," +
            "\"last_update_time\":{\"type\":\"date\"," +
            "\"format\":\"strict_date_time||epoch_millis\"}," +
            "\"schedule\":{\"properties\":{\"period\":{\"properties\":" +
            "{\"interval\":{\"type\":\"integer\"}," +
            "\"unit\":{\"type\":\"keyword\"}}},\"cron\":{\"properties\":" +
            "{\"expression\":{\"type\":\"text\"}," +
            "\"timezone\":{\"type\":\"keyword\"}}}}},\"inputs\":" +
            "{\"type\":\"nested\",\"properties\":{\"search\":{\"properties" +
            "\":{\"indices\":{\"type\":\"text\"," +
            "\"fields\":{\"keyword\":{\"type\":\"keyword\",\"ignore_above\":256}}}," +
            "\"query\":{\"type\":\"object\"," +
            "\"enabled\":false}}},\"anomaly_detector\":{\"properties\":{\"detector_id\":{\"type" +
            "\":\"keyword\"}}}}}," +
            "\"triggers\":{\"type\":\"nested\",\"properties\":{\"name\":{\"type\":\"text\"," +
            "\"fields\":{\"keyword\":" +
            "{\"type\":\"keyword\",\"ignore_above\":256}}}," +
            "\"min_time_between_executions\":{\"type\":\"integer\"}," +
            "\"condition\":{\"type\":\"object\",\"enabled\":false}," +
            "\"actions\":{\"type\":\"nested\",\"properties\":" +
            "{\"name\":{\"type\":\"text\"," +
            "\"fields\":{\"keyword\":{\"type\":\"keyword\",\"ignore_above\":256}}}," +
            "\"destination_id\":{\"type\":\"keyword\"}," +
            "\"subject_template\":{\"type\":\"object\",\"enabled\":false}," +
            "\"message_template\":{\"type\":\"object\"," +
            "\"enabled\":false},\"throttle_enabled\":{\"type\":\"boolean\"}," +
            "\"throttle\":{\"properties\":{\"value\":{\"type" +
            "\":\"integer\"},\"unit\":{\"type\":\"keyword\"}}}}}}}," +
            "\"ui_metadata\":{\"type\":\"object\",\"enabled\":false}}}," +
            "\"destination\":{\"dynamic\":\"false\"," +
            "\"properties\":{\"schema_version\":{\"type\":\"integer\"}," +
            ...
            "\"ignore_above" +
            "\":256}}}}},\"slack\":{\"properties\":{\"url\":{\"type\":\"text\",\"fields\":{\"keyword\":" +
            "{\"type\":\"keyword\"," +
            "\"ignore_above\":256}}}}},\"custom_webhook\":{\"properties\":{\"url\":{\"type\":" +
            "\"text\",\"fields\":{\"keyword" +
            "\":{\"type\":\"keyword\",\"ignore_above\":256}}},\"scheme\":" +
            "{\"type\":\"keyword\"},\"host\":{\"type\":\"text\"}," +
            "\"port\":{\"type\":\"integer\"},\"path\":" +
            "{\"type\":\"keyword\"},\"query_params\":{\"type\":\"object\"," +
            "\"enabled\":false},\"header_params\":" +
            "{\"type\":\"object\",\"enabled\":false},\"username\":{\"type\":\"text\"}," +
            "\"password\":" +
            "{\"type\":\"text\"}}}}}}}}";
    ...
    public void testCreateAnomalyDetectorWithNotExistingIndices() throws Exception {
        ...
        TestHelpers.assertFailWith(ResponseException.class,
    ...
    public void testCreateAnomalyDetectorWithEmptyIndices() throws Exception {
        AnomalyDetector detector = TestHelpers.randomAnomalyDetector(TestHelpers.randomUiMetadata(), null);
        TestHelpers.makeRequest(client(),
            "PUT",
    ...
    public void testCreateAnomalyDetector() throws IOException {
        ...
        Response
            response =
            TestHelpers.makeRequest(client(), "POST", TestHelpers.AD_BASE_DETECTORS_URI, ImmutableMap.of(), toHttpEntity(detector), null);
    ...
    public void testUpdateAnomalyDetector() throws IOException {
        ...
        AnomalyDetector newDetector = new AnomalyDetector(detector.getDetectorId(),
            detector.getVersion(),
            detector.getName(),
            newDescription,
        ...
        Response updateResponse = TestHelpers.makeRequest(client(),
            "PUT",
    ...
    public void testSearchAnomalyDetector() throws IOException {
        ...
        Response searchResponse = TestHelpers.makeRequest(client(),
            "GET",
    ...
    public void testPreviewAnomalyDetector() throws IOException {
        ...
        AnomalyDetectorExecutionInput
            input =
            new AnomalyDetectorExecutionInput(detector.getDetectorId(), Instant.now().minusSeconds(60 * 10), Instant.now());
        Response
            response =
            TestHelpers.makeRequest(client(), "POST", TestHelpers.AD_BASE_PREVIEW_URI, ImmutableMap.of(), toHttpEntity(input), null);
    ...
    public void testPreviewAnomalyDetectorWhichNotExist() throws Exception {
        ...
        AnomalyDetectorExecutionInput
            input =
            new AnomalyDetectorExecutionInput(randomAlphaOfLength(5), Instant.now().minusSeconds(60 * 10), Instant.now());
        TestHelpers.assertFailWith(ResponseException.class,
            () -> TestHelpers.makeRequest(client(), "POST", TestHelpers.AD_BASE_PREVIEW_URI, ImmutableMap.of(), toHttpEntity(input), null));
    }
    ...
    public void testSearchAnomalyResult() throws IOException {
        ...
        Response response = TestHelpers.makeRequest(client(),
            "POST",
        ...
        SearchSourceBuilder
            search =
            (new SearchSourceBuilder()).query(QueryBuilders.termQuery("detector_id", anomalyResult.getDetectorId()));
        Response searchResponse = TestHelpers.makeRequest(client(),
            "POST",
        ...
        Response searchAllResponse = TestHelpers.makeRequest(client(),
            "POST",
            TestHelpers.AD_BASE_RESULT_URI + "/_search",
            ImmutableMap.of(),
    ...
    public void testDeleteAnomalyDetectorWithUsedByMonitor() throws Exception {
        ...
        Response createResponse = TestHelpers.makeRequest(client(),
            "POST",
            ...
            ("{\"monitor\":{\"type\":\"monitor\",\"name\":\"test-monitor-with-ad\",\"enabled\":true,\"schedule\":" +
                "{\"period" +
                "\":{\"interval\":1,\"unit\":\"MINUTES\"}},\"inputs\":[{\"anomaly_detector\":" +
                "{\"detector_id" +
                "\":\"DETECTOR_ID_PLACEHOLDER\"}}],\"triggers\":[{\"name\":\"T1\",\"severity\":" +
                "\"1\",\"condition\":{\"script" +
                "\":{\"source\":\"ctx.results[0].anomalyGrade > 0.9\",\"lang\":" +
