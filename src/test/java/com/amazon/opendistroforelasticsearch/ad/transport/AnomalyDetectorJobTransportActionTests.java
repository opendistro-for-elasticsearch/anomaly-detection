...
public class AnomalyDetectorJobTransportActionTests extends HistoricalDetectorIntegTestCase {
    ...
    // assertNotNull(response.getDetectorProfile().getAdTaskProfiles());
    //
    // ADTask finishedTask = getADTask(adTask.getTaskId());
    // int i = 0;
    ...
    // assertNull(response.getDetectorProfile().getAdTaskProfiles().get(adTask.getTaskId()).getNodeId());
    // ADTask profileAdTask = response.getDetectorProfile().getAdTaskProfiles().get(adTask.getTaskId()).getAdTask();
    ...
    // ADTaskProfile taskProfile1 = response1.getDetectorProfile().getAdTaskProfiles().get(adTask1.getTaskId());
    // ADTaskProfile taskProfile2 = response2.getDetectorProfile().getAdTaskProfiles().get(adTask2.getTaskId());
