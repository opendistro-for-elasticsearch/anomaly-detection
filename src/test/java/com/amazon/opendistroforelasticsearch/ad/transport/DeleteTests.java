...
public class DeleteTests extends AbstractADTest {
    ...
    public <R extends ActionRequest> void testSerialzationTemplate(
        R request, R readRequest, Supplier<String> requestSupplier, Supplier<String> readRequestSupplier) throws IOException {
        BytesStreamOutput output = new BytesStreamOutput();
    ...
    public <R extends ToXContent> void testJsonRequestTemplate(R request, Supplier<String> requestSupplier) throws
        IOException,
    ...
    public void deleteDetectorResponseTemplate(DetectorExecutionMode mode) throws Exception {
        ...
        DeleteDetectorTransportAction
            action =
            new DeleteDetectorTransportAction(transportService,
                clusterService,
                threadPool,
                actionFilters,
                indexNameResolver,
