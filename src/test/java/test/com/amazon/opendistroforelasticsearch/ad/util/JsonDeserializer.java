...
public class JsonDeserializer {
     ...
     * @return the matching string or null in case of no match.
     */
    public static String getTextValue(JsonElement jsonElement, String path, boolean returnEmptyStringIfMissing) throws
     ...
     * @throws IOException if the underlying input source has IO issues during parsing
     */
    public static String getTextValue(String jsonString, String paths, boolean returnEmptyStringIfMissing) throws
        JsonPathNotFoundException,
        IOException {
        try {
    ...
    public static <T> T[] getArrayValue(
        String jsonString, Function<JsonElement, T> function, String... paths) throws JsonPathNotFoundException, IOException {
    ...
    public static <T> List<T> getListValue(String jsonString, Function<JsonElement, T> function, String... paths) throws
        JsonPathNotFoundException,
        IOException {
        JsonElement jsonNode = getChildNode(jsonString, paths);
        if (jsonNode != null && jsonNode.isJsonArray()) {
